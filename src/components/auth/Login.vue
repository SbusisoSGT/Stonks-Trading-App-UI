<template>
    <div class="form-container">
        <form id="loginForm" action="POST" @submit.prevent="processLoginForm">
            ...
            <h1 class="form-header">Login to Continue</h1>
            ...
            <div class="form-group">
                ...
                <div class="form-group-password">
                    <input type="password" name="password" id="form-password-input" class="form-input" v-model="password"> 
                    <span class="form-password-toggle" @click="togglePassword()">Show</span>
                </div>
            </div>
            <button type="submit" class="form-submit">Login</button>
            <div class="sign-up-container">
                <span class="sign-up-question">Don't have an account?</span>
                <span class="sign-up-link"><router-link to="/register">Sign up</router-link></span> 
            </div>
        </form>
    </div>
</template>
...
export default {
    ...
    methods: {
        ...
        togglePassword () {
            let showPassword = document.querySelector('.form-password-toggle');

            let passwordInput = showPassword.previousElementSibling;
